...
class VariantSelects extends HTMLElement {
  ...
  //     document,this.querySelectorAll('[thumbnail-alt]').forEach(img => img.style.display = 'none');
  //     const currentImageAlt = this.currentVariant.featured_image.alt;
  //     const thumbnailSelector = `[thumbnail-alt = '${currentImageAlt}']`;
  //     document,this.querySelectorAll(thumbnailSelector).forEach(img => img.style.display = 'block');
  //   } else {
  //     //show all thumbnails
  //     document,this.querySelectorAll('[thumbnail-alt]').forEach(img => img.style.display = 'block');
  //   }
  // }
